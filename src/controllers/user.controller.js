...
const changePassword = asyncHandler(async (req, res) => {
  ...
  //   throw new ApiError(
  //     400,
  //     "New password and confirm password doest not match"
  //   );
  // }
...
const updateAccountDetail = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Account details updated successfullyn"));
});
...
const updateUserAvater = asyncHandler(async (req, res) => {
  ...
  res.status(200).json(ApiResponse(200, user, "update avatar successfully"));
});
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(ApiResponse(200, user, "update cover image successfully"));
});
